  ...
  return (
    <>
      ...
      <div
        className="preloader"
        id="preloader"
        dangerouslySetInnerHTML={{ __html: PRELOADER_SVG }}
      ></div>
      <Header />
      <main id="top">
        <Hero />
