...
export default function Boarding() {
  return (
    <section className="boarding" id="boarding">
      <img className="bcl bcl-1" src="/assets/img/cloud-left-2.png" alt="" aria-hidden="true" />
      <img className="bcl bcl-2" src="/assets/img/cloud-right-2.png" alt="" aria-hidden="true" />
      <img className="bcl bcl-3" src="/assets/img/cloud-4.png" alt="" aria-hidden="true" />
      <div className="boarding-pass">
        ...
        <form className="bp-stub-r" id="accessForm" noValidate>
          <div className="bp-meta">
            <span className="bp-num"><i className="bp-hash">#</i> <b id="bpNum">RNW8799</b></span>
            <span className="bp-date"><label>Date</label> <b id="bpDate">22 JUL. 2026</b></span>
          </div>
          <div className="bp-fields">
            <div className="bp-field"><input id="fname" name="name" type="text" autoComplete="name" placeholder="First &amp; Last Name" required /></div>
            <div className="bp-field"><input id="femail" name="email" type="email" autoComplete="email" placeholder="Work Email" required /></div>
          </div>
          <a className="btn-getaccess" href="/signup">Get Access <span dangerouslySetInnerHTML={{ __html: GA_CIRCLE }} /></a>
          <p className="bp-done" id="bpDone" hidden>&#10003; You&#8217;re on the list. Boarding soon.</p>
        </form>
