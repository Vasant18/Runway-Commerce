...
export default function Footer() {
  return (
    <footer className="site-footer" id="footer">
      ...
      <div className="footer-word" aria-hidden="true" dangerouslySetInnerHTML={{ __html: FOOTER_LOGO }} />
      <div className="footer-grid">
        <div className="footer-card">
          ...
          <div className="fc-legal">
            <div className="fc-row">&#169; 2026 CrossBorder Marketplace</div>
